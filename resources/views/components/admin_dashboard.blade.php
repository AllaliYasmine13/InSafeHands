                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no">Patients Agées</p>
                     ...
                     <div class="row column4 graph">
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="task_list_main">
                                    <ul class="task_list">
                                       <li><a href="#">Meeting about plan for Admin Template 2022</a><br><strong>10:00 AM</strong></li>
                                       <li><a href="#">Create new task for Dashboard</a><br><strong>10:00 AM</strong></li>
                                       <li><a href="#">Meeting about plan for Admin Template 2022</a><br><strong>11:00 AM</strong></li>
                        ...
                        <div class="col-md-6">
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 <div class="dash_head">
                                    <h3><span><i class="fa fa-comments-o"></i> Liste des Patients Agées</span><span class="plus_green_bt"><a href="#">+</a></span></h3>
                                 </div>
                                 <div class="list_cont">
