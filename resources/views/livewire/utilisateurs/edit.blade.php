<div class="row p-4 pt-5">
    <div class="col-md-6">
        ...
        <div class="card card-primary">
              <div class="dash_head">
                  <h3><span><i class="fa fa-user-plus fa-2x"></i> Formulaire d'édition utilisateur </span><span class="plus_green_bt"><a href="">+</a></span></h3>
              </div>          
            <!-- /.card-header -->
            <!-- form start -->
    ...
    <div class="col-md-6">
        <div class="row ">
            <div class="col-md-12">
                <div class="card card-primary">
                <div class="dash_head">
                  <h3><span><i class="fa fa-key"></i> Réinitialisation de mot de passe</span></h3>
              </div>
