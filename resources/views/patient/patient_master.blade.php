            ...
            <nav id="sidebar"> 
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        <a href="{{ route ('patient.dashboard') }}"><i class="fa fa-home yellow_color"> </i> <span> Accueil </span></a>
                     ...
                     <li>
                        <a href="#apps" ><i class="fa fa-user-md blue2_color"></i> <span>Patient Info</span></a>
                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd"> 
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="{{ asset ('images/layout_img/doctor_01.jpg') }}" alt="#" /><span class="name_user">Patient</span></a>
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="profile.html">My Profile</a>
                                       <a class="dropdown-item" href="settings.html">Settings</a>
                                       <a class="dropdown-item"href="{{ route('patient.logout') }}" ><span>Log Out</span> <i class="fa fa-sign-out"></i></a>
                                    </div>
                                 </li>
                              </ul>
                           </div>
