...
Route::get('/gestion_des_rdvs', [App\Http\Controllers\HomeController::class, 'Gestion_Rdvs'])->name('gestion_des_rdvs');

Route::get('/profile/edit_profile', [App\Http\Controllers\HomeController::class, 'EditProfile'])->name('edit_profile');
Route::get('/profile/change_password', [App\Http\Controllers\HomeController::class, 'EditPassword'])->name('edit_password');
