...
class UtilisateurComponent extends Component
{
    ...
    public $user_id, $name, $email, $password, $role, $user_edit_id, $user_delete_id;
    
    // $sexe, $date_naissance, $telephone1, $telephone2, $pieceIdentite, $numeroPieceIdentite
    
    public $view_user_name, $view_user_email, $view_user_password, $view_user_role;
    
    // $view_user_photo, $view_user_sexe, $view_user_date_naissance, $view_user_pieceIdentite, $view_user_numeroPieceIdentite, $view_user_telephone1, $view_user_telephone2;
...
public function updated($fields)
{
    ...
    public function storeUserData(){
        ...
        // if($this->photo != null) {
        //     $this->photo->store('upload', 'public');
        //  }
        //Add Student Data
        $user =new User();
...
public function cancel()
{
    ...
    public function render()
    {
        ...
        ->orWhere('email','like','%'.$this->searchTerm.'%')->get();
